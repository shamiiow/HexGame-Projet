...
class WaitingScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Titre
        self.title = Label(text='Waiting Screen ...', font_size=90, color=(176 / 255, 97 / 255, 97 / 255))
        ...
        self.texte = Label(text = "Pick the grid size :", font_size = 40, color=(176 / 255, 97 / 255, 97 / 255))
