...
def reply_Menudefault():
    ...
    for i in range(len(list_of_rooms)):
        if (
            len(list_of_rooms[i]) == 2
            and list_of_rooms[i][0][0] not in dico_grid.keys()
        ):
...
def print_info(data, conn, reply):
    print(
        "--------------------------Information Brute Trade------------------------------------"
    )
    print(f"data: {data}")
    print(f"reply: {reply}")
    print(
        "--------------------------Information Generales Serveur------------------------------"
    )

    print("List of players :")
    for key, value in saveID.items():
        print(
            f"    -{str(str(key.getpeername()[0])+":"+str(key.getpeername()[1]))} : {value}"
        )
    print("List of rooms :")
    ...
    print(
        "--------------------------Fin Information Generales Serveur--------------------------"
    )
